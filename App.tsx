...
import CentralCommand from './components/command/CentralCommand'; 

// Context
import { MatrixProvider } from './context/MatrixContext';
import { TacticalProvider } from './context/TacticalContext';
import { LogProvider } from './context/LogContext';
import { SystemPulseProvider } from './context/SystemPulseContext'; // <--- IMPORTACIÓN CRÍTICA
...
const App: React.FC = () => {
  ...
  return (
    <LogProvider>
      <SystemPulseProvider> {/* <--- ACTIVACIÓN DEL PULSO */}
        <MatrixProvider>
          <TacticalProvider>
